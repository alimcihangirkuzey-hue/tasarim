...
| K-04 | **ADR/TDR ayrımı** kuruldu; mimari ve teknoloji kararları ayrı numaralandırılır. ⚠️ **Şerh (v4.1.0):** "numara çakışması giderildi" ibaresi **ilke düzeyinde** doğrudur, **icra edilmemiştir** — bkz. EK-C / A-08. |
...
| A-08 | ADR numaralandırma çakışmasının icrası | K-04 çakışmanın giderildiğini ilan etti, ancak hiçbir dosya yeniden adlandırılmadı, tek bir TDR kaydı oluşturulmadı ve canlı `TODO.md` hâlâ teknoloji ADR'sine `ADR-7` diye atıf yapıyor. İlke ile icra ayrışmış durumda. |
